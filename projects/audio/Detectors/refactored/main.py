...
sys.path.append('../../LA/Baseline-LFCC-LCNN/')
...
def produce_evaluation_file(dataset, model, device, save_path):
    data_loader = DataLoader(dataset, batch_size=384, shuffle=False, drop_last=False)
    model.eval()
...
if __name__ == '__main__':
    ...
    # Dataset
    parser.add_argument('--database_path', type=str, default='../../../../Samples/ASVspoof2021LA/', help='Change this to user\'s full directory address of LA database (ASVspoof2019- for training & development (used as validation), ASVspoof2021 for evaluation scores). We assume that all three ASVspoof 2019 LA train, LA dev and ASVspoof2021 LA eval data folders are in the same database_path directory.')
    '''
    % database_path/
    %   |- LA
    ...
    parser.add_argument('--protocols_path', type=str, default='../../../../Samples/ASVspoof2021LA/ASVspoof2021_LA_eval/', help='Change with path to user\'s LA database protocols directory address')
    '''
    % protocols_path/
    ...
    #evaluation 
    if args.eval:
        file_eval = genSpoof_list( dir_meta =  os.path.join(args.protocols_path+'{}.cm.eval.trl.txt'.format(prefix_2021)),is_train=False,is_eval=True)
